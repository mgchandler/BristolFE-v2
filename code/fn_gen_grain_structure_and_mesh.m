function [mod, GRAIN_label] = fn_gen_grain_structure_and_mesh(G1,RUN_NUM,elementtype,el_size,sample_width,sample_depth,mat)
...
for run_num=1:RUN_NUM(ig1)
    ...
    [VX_1,VY_1,V_1,C_1]=fn_grain_structure_one_grain_size...
        (g1,grain_size_spread_1,sample_width,sample_depth);
    ...
    % Assigns the mesh elements to each grain
     [GRAIN_label] = fn_label_grains_using_VC(ele_cen,V_1,C_1);
