function [res, mats] = fn_BristolFE_v4(mod, matls, steps, fe_options)
%SUMMARY
...
if ~isfield(mod, 'el_typ_i')
    ...
    mod.el_typ_i = {current_matl.el_type};
    mod.el_typ_i = mod.el_typ_i(:);
end %MODIFY THIS SCRIPT FOR UNIQUE MATERIALS.
...
[mats.K, mats.C, mats.M, mats.gl_lookup] = fn_build_global_matrices_v6(mod.nds, mod.els, mod.el_mat_i, mod.el_abs_i, mod.el_typ_i, matls, fe_options);
