...
% Define parameters
time_of_flight1 = 3.3e-7; % 3e-7, 1.8
time_of_flight2 = 1.9e-6; % 2.1e-6
...
for idx = 1:iter_range
    ...
    % spatial variance
    igroups_spatial_variance_data_scatter=igroups_mean_square_data_scatter-igroups_data_scatter.^2;
    groups_spatial_variance_data_scatter=igroups_spatial_variance_data_scatter;
    % mle
    groups_mle_spatial_variance = fn_rlt1(groups_spatial_variance_data_scatter');
    % 计算depth_time
    ...
    % 
    % figure;
    % [ax, h1, h2] = plotyy(groups_depth_time*1e3,igroups_data_scatter,groups_depth_time*1e3,groups_mle_spatial_variance);
    % set(h1,'LineWidth', lw);
    % set(h2,'LineWidth', lw);
