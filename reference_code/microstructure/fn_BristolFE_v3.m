function [res, mats] = fn_BristolFE_v3(mod, matls, steps, fe_options)
%SUMMARY
...
[mats.K, mats.C, mats.M, mats.gl_lookup] = fn_build_global_matrices_v5(mod.nds, mod.els, mod.el_mat_i, mod.el_abs_i, mod.el_typ_i, mod.matTypeRefs, mod.matEl,  matls, fe_options);
