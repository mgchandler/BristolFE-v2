...
for run_num=1:RUN_NUM(ig1)
    ...
    % fwave = figure('Visible','on');
    % histogram(grain_size_1*1e6,'binwidth',1,'Normalization', 'pdf', 'FaceColor', [0.929, 0.694, 0.125]); hold on; %'FaceColor', [0, 0.2, 0.5]
    % hold on
    % histogram(grain_size_2*1e6,'binwidth',1,'Normalization', 'pdf', 'FaceColor',[0.494, 0.184, 0.556]); %'FaceColor',[0.5, 0.5, 0.5]
    ...
    legend(['M1\_G1: $ \ \sigma_1 =' num2str(round(std_1,1)) '\mathrm{\mu m}$' ],...
        ['M1\_G2: $ \ \sigma_2 =' num2str(round(std_2,1)) '\mathrm{\mu m}$' ],'location','northeast','Interpreter','latex','FontSize', 14);
   
    saveas(gcf, 'PDF_Blue.png', 'png');

    
     % Create a structure containing all variables
    % data_S1.r_1_S1 = r_1;
    % data_S1.wr_1_S1 = wr_1;
    % data_S1.wr_2_S1 = wr_2;
    % data_S1.r_2_S1 = r_2;
    % data_S1.ad_1_S1 = ad_1;
    % data_S1.aL_1_S1 = aL_1;
    % data_S1.aL_2_S1 = aL_2;
    % data_S1.ad_2_S1 = ad_2;
    % data_S1.std_1_S1 = std_1;
    % data_S1.std_2_S1 = std_2;
    % data_S1.grain_size_1_S1 = grain_size_1;
    % data_S1.grain_size_2_S1 = grain_size_2;
    % 
    % % Save the structure to a .mat file
    % save('data_S1.mat', '-struct', 'data_S1');
